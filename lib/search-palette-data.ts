...
export const PRESET_SEARCH_ITEMS: SearchPaletteItem[] = [
  ...
  {
    id: 'layout-dauthau',
    title: 'Tình Báo Đấu Thầu Y Tế & Đầu Tư Công',
    subtitle: 'Theo dõi gói thầu trúng kênh ETC, 6 cổ phiếu Dược & 71 đại dự án ĐTC',
    icon: '⚖️',
    category: 'layout',
    categoryLabel: 'Bố cục',
    href: '/dau-thau',
    keywords: ['dau thau', 'y te', 'duoc', 'dp1', 'dtp', 'dan', 'tra', 'cdp', 'dtg', 'dau tu cong', 'dtc'],
  },
  {
    id: 'layout-nganhdien',
    title: 'Dữ Liệu Ngành Điện NSMO & EAV (36 Cổ Phiếu)',
    subtitle: 'Giá cận biên thị trường SMP, quan trắc 16 hồ chứa & dự báo 36 mã điện',
    icon: '⚡',
    category: 'layout',
    categoryLabel: 'Bố cục',
    href: '/nganh-dien',
    keywords: ['nganh dien', 'dien', 'nsmo', 'eav', 'smp', 'thuy dien', 'nhiet dien', 'pow', 'ree', 'geg', 'hdg'],
  },
  {
    id: 'layout-thuysan',
    title: 'Tình Báo Thủy Sản VASEP & Giá Nguyên Liệu (12 Cổ Phiếu)',
    subtitle: 'Kim ngạch xuất khẩu 8T, giá cá tra - tôm hàng tuần & dự phóng Q3 12 mã',
    icon: '🐟',
    category: 'layout',
    categoryLabel: 'Bố cục',
    href: '/thuy-san',
    keywords: ['thuy san', 'vasep', 'ca tra', 'tom', 'vhc', 'anv', 'fmc', 'mpc', 'cmx', 'abt', 'khs', 'acl', 'cat', 'aam', 'cca'],
  },
  {
    id: 'layout-xnk',
