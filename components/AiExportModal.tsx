...
export function AiExportModal({ open, onClose, ticker, companyName }: AiExportModalProps) {
  ...
  const handleCopyPrompt = async () => {
    ...
    try {
      // Đối với Gemini / NotebookLM có context window lớn: dùng bundleMarkdown toàn diện
      // Đối với ChatGPT / Claude / DeepSeek: dùng compactPrompt hoặc bundleMarkdown tùy chọn
      const contentToCopy =
